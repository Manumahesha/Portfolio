                ...
                <div className="space-y-6 mt-auto">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-400">+91 9880105027</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-400">manumaheshdgp@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-400">Chamarajanagar, Karnataka, India</p>
                    </div>
                  </div>
                </div>
              </div>
